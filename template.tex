...
$if(ready-to-publish)$
  ...
  \usepackage[bb=lucida,bbscaled=0.9,cal=boondoxo]{mathalpha}
$else$
  \usepackage{amssymb}
$endif$
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE]{\thepage \quad $title$}
\fancyhead[RO]{$authors_short$ \quad \thepage}
\renewcommand{\headrulewidth}{0pt}
\fancypagestyle{firstpagefooter}{
  \fancyhf{}
  \fancyfoot[C]{The Journal of Fair Replication Studies - ISBN: 978-1-7380675-1-0\\$title$ - DOI: PENDING}
}
